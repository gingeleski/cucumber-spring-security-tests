...
import roombook.dto.LoginDto;
import roombook.model.user.User;
import roombook.security.jwt.JWTFilter;
...
/**
 * Controller to authenticate and manage users.
 */
@RestController
@RequestMapping("/api")
public class UserController
{
    ...
    /**
     * Object to return as body for successful JWT authentication.
     */
